    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            self.client = MongoClient(
                ...
                serverSelectionTimeoutMS=self.db_config.connection_timeout,
                connectTimeoutMS=self.db_config.connection_timeout,
                socketTimeoutMS=self.db_config.connection_timeout
            )
            ...
            self.collection = self.db['games']  # Collection par défaut
            
            logger.info(f"✅ Connecté à MongoDB: {self.db_config.database_name}")
            return True
